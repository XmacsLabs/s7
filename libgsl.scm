...
;	 (int gsl_integration_qawo_table_set_length (gsl_integration_qawo_table* double))
	 ...
	 ;; (int gsl_multifit_linear_lcurvature_menger (gsl_vector* gsl_vector*eta gsl_vector*))
	 ...
	 ;; (int gsl_bspline_vector_calc_deriv (double gsl_matrix* size_t nderiv gsl_vector* gsl_bspline_workspace*))
